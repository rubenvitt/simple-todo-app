...
export class ListSharesController {
    ...
    async shareList(
        ...
        return this.listSharesService.shareList(req.user.id, listId, createListShareDto);
    }
    ...
    async updateListShare(
        ...
        return this.listSharesService.updateListShare(req.user.id, listId, targetUserId, updateListShareDto);
    }
    ...
    async removeListShare(
        ...
        return this.listSharesService.removeListShare(req.user.id, listId, targetUserId);
    }
} 