...
describe('PrismaService', () => {
    ...
    describe('Construction and Configuration', () => {
        ...
        it('should use development logging in development environment', () => {
            mockConfigService.get.mockImplementation((key: string) => {
                ...
                if (key === 'DATABASE_URL') return 'postgresql://test:test@localhost:5432/test_db';
                return undefined;
            });
    ...
    describe('Connection Management', () => {
        ...
        it('should disconnect gracefully on module destroy', async () => {
            ...
            expect(mockLogger.log).toHaveBeenCalledWith('Disconnecting from database...');
            expect(mockLogger.log).toHaveBeenCalledWith('Successfully disconnected from database');
        });
    ...
    describe('Health Check', () => {
        it('should return healthy status on successful query', async () => {
            jest.spyOn(service, '$queryRaw').mockResolvedValueOnce([{ health_check: 1 }]);
    ...
    describe('Query Execution with Retry', () => {
        ...
        it('should not retry on non-connection errors', async () => {
            ...
            await expect(service.executeWithRetry(mockOperation)).rejects.toThrow('validation error');
        ...
        it('should throw error after max retries', async () => {
            ...
            await expect(service.executeWithRetry(mockOperation, 2)).rejects.toThrow('timeout');
