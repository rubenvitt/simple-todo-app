...
export class ListsController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new todo list. The authenticated user becomes the owner of the list.',
  })
  @ApiBody({
    type: CreateListDto,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all lists accessible to the authenticated user (owned lists and shared lists)',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a specific list by ID. User must have access to the list (owner or shared access).',
  })
  @ApiParam({
    name: 'id',
    type: String,
  ...
  @ApiOperation({
    ...
    description:
      'Update an existing list. Requires EDITOR or OWNER permission level.',
  })
  @ApiParam({
    name: 'id',
    type: String,
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden - Insufficient permissions (requires EDITOR or OWNER)',
    example: {
  ...
  @ApiOperation({
    ...
    description:
      'Delete an existing list. Requires OWNER permission level. This will also delete all associated tasks and shares.',
  })
  @ApiParam({
    name: 'id',
    type: String,
