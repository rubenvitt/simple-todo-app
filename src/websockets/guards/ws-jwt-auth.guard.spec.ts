...
describe('WsJwtAuthGuard', () => {
    ...
    describe('canActivate', () => {
        ...
        it('should deny access when token is invalid', async () => {
            // Arrange
            const mockSocket = createMockSocket({ authHeader: 'Bearer invalid-token' });
            const context = createMockContext(mockSocket) as any;
            ...
            expect(result).toBe(false);
            expect(mockSocket.disconnect).toHaveBeenCalled();
            expect(jwtService.verify).toHaveBeenCalledWith('invalid-token', { secret: 'test-secret' });
        });
        ...
        it('should handle malformed authorization header', async () => {
            // Arrange
            const mockSocket = createMockSocket({ authHeader: 'InvalidFormat token' });
            const context = createMockContext(mockSocket) as any;
